...
| 文件 | 路径 | 用途 |
|------|------|------|
| PRD 语言规范 | `.claude/agentpm-knowledge/phase1-requirements/prd-language.md` | 禁止词汇、内容分级 |
| 章节格式规范 | `.claude/agentpm-knowledge/phase1-requirements/section-format.md` | 结构要求 |
