        ...
        <ElTable v-loading="loading" :data="tableData" height="100%" style="width: 100%">
          ...
          <ElTableColumn label="操作" width="250" align="center" fixed="right">
            <template #default="{ row }">
              <ElButton link type="primary" @click="handleEdit(row as RoleItem)">编辑</ElButton>
              <ElButton link type="primary" @click="handleAssignPermissions(row as RoleItem)">分配权限</ElButton>
              <ElButton link type="danger" @click="handleDelete(row as RoleItem)">删除</ElButton>
            </template>
          </ElTableColumn>
        </ElTable>
      </div>
