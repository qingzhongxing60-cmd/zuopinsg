        ...
        >
          ...
          <ElTableColumn label="显示" width="100" align="center">
            <template #default="{ row }">
              <ElSwitch
                ...
                :active-value="1"
                :inactive-value="0"
                @change="handleStatusChange(row as MenuItem)"
              />
            </template>
          </ElTableColumn>
          <ElTableColumn label="操作" width="200" align="center" fixed="right">
            <template #default="{ row }">
              ...
              <ElButton link type="primary" @click="handleEdit(row as MenuItem)">编辑</ElButton>
              <ElButton link type="danger" @click="handleDelete(row as MenuItem)">删除</ElButton>
            </template>
          </ElTableColumn>
        </ElTable>
      </div>
